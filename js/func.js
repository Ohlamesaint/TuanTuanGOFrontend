        ...
        belowBar[i].addEventListener("click", (e) => {
            ...
            if (i == 0) {     //my profile 利用req.session來查詢並獲得
                ...
                */
                ...
                document.querySelector("#bluetooth").addEventListener("click", async () => {
                ...
                document.querySelector("#modal_close").addEventListener("click", async () => {
                    document.getElementById('transfer_information').remove();
